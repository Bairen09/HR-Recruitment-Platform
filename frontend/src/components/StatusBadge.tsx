...
const STATUS_STYLES: Record<CandidateStatus, string> = {
  ...
  FIRST_CALL_PENDING: "bg-primary/10 text-primary border-primary/20",
  FIRST_CALL_DONE: "bg-primary/15 text-primary border-primary/30",
  SECOND_CALL_PENDING: "bg-primary/10 text-primary border-primary/20",
  SECOND_CALL_DONE: "bg-primary/15 text-primary border-primary/30",
  THIRD_CALL_PENDING: "bg-primary/10 text-primary border-primary/20",
...
const STATUS_LABEL: Record<CandidateStatus, string> = {
  ...
  FIRST_CALL_PENDING: "1st Call Pending",
  FIRST_CALL_DONE: "1st Call Done",
  SECOND_CALL_PENDING: "2nd Call Pending",
  SECOND_CALL_DONE: "2nd Call Done",
  THIRD_CALL_PENDING: "3rd Call Pending",
